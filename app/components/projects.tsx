...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      className="w-full flex flex-col items-center justify-center bg-white py-8 px-4 min-h-[100vh]"
    >
      ...
      <div className="grid sm:grid-cols-2 max-w-2xl gap-4 w-full justify-center items-center">
        {projects.map((project, index) => (
          <Card
            key={index}
            className="bg-card border border-gray-200 shadow-md overflow-hidden transition-transform transform hover:scale-105"
          >
